...
namespace WinService
{
    public partial class MainService : ServiceBase
    {
        ...
        public void ExeTask()
        {
            FixedRateTimer OneTask = new FixedRateTimer(TimeSpan.FromSeconds(10), TimeSpan.FromSeconds(86400), task =>
            {
                try
                {
                    //写要做的任务：
                    ...
                    SendSMSMessageService service = new SendSMSMessageService();
                    service.RedminRemainderSmsCountNotFull();
                }
                catch
                {
