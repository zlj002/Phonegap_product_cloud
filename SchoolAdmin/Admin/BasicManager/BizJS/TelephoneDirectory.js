...
var page = {
    getEntity: function (id) {
        ...
        $.ajax({
            ...
            url: "TelephoneDirectory.aspx/GetEntity",
            data: "{'ID':'" + id + "'}",
            dataType: "json",
    ...
    bindList: function () {
        table = $('#tableList').dataTable({
            ...
            "aoColumns": [
                ...
                {
                    "sClass": "center", "mDataProp": "ExtNumber"
                }
            ],
            "oLanguage": { //国际化配置  
            ...
            "sAjaxSource": "Handler/TelephoneDirectoryHandler.ashx?action=GetTelephoneDirectoryList&now=" + new Date().getTime(),
            //服务器端，数据回调处理  
            ...
            "fnRowCallback": function (nRow, aData, iDataIndex) {
                ...
                var checkbox = $('<input title="选择" type="checkbox" name="check_' + aData.ID + '"   id="' + aData.ID + '"/>');
    ...
    bindEvents: function () {
        ...
        $("#btnSave").bind("click", function () {
            ...
            $.ajax({
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                url: "TelephoneDirectory.aspx/InsertOrUpdate",
                data: "{'entity':" + os + "}",
                dataType: "json",
                success: function (result) {
            ...
            if (confirm("确定要删除吗？")) {
                ...
                if (ids.length == 0) {
                    ...
                    $.ajax({
                        type: 'POST',
                        contentType: "application/json; charset=utf-8",
                        url: "TelephoneDirectory.aspx/Delete",
                        data: "{'ids':" + os + "}",
                        dataType: "json",
                        success: function (result) {
                            var returnData = result.d; // JSON.parse(result.d);
