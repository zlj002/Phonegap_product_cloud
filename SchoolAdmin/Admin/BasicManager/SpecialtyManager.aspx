<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeFile="SpecialtyManager.aspx.cs" Inherits="Admin_BasicManager_SpecialtyManager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="BizJS/SpecialtyManager.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive">
                <fieldset>
                    <legend style="font-weight: bold;">专业介绍</legend>
                    专业名称:
                    <input name="Name1" class="column_filter" />
                    <br />
                    <br />
                </fieldset>
                <fieldset>
    ...
    <div class="modal fade" id="divInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"   data-backdrop="static">
            ...
            <div class="modal-content" style="width: 850px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="height: 400px;">
                        <div class="col-xs-2">
                           <font color="red">*</font>  详细
                        </div>
                        <div class="col-xs-2" >
                            <script id="Description" type="text/plain" style="width: 650px; height: 200px;"></script>
                        </div>
                    </div>
