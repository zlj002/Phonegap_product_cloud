...
var page = {
    getEntity: function (id) {
        ...
        $.ajax({
            ...
            url: "Basic_CampusManager.aspx/GetEntity",
            data: "{'campusID':'" + id + "'}",
            dataType: "json",
    ...
    bindList: function () {
        table = $('#tableList').dataTable({
            ...
            "sAjaxSource": "/Base/Basic_CampusHandler.ashx?action=GetCampusList&now=" + new Date().getTime(),
            //服务器端，数据回调处理  
    ...
    bindEvents: function () {
        ...
        $("#btnSave").bind("click", function () {
            ...
            $.ajax({
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                url: "Basic_CampusManager.aspx/InsertOrUpdate",
                data: "{'entity':" + os + "}",
                dataType: "json",
                success: function (result) {
            ...
            if (confirm("确定要删除吗？")) {
                ...
                if (ids.length == 0) {
                    ...
                    $.ajax({
                        type: 'POST',
                        contentType: "application/json; charset=utf-8",
                        url: "Basic_CampusManager.aspx/Delete",
                        data: "{'ids':" + os + "}",
                        dataType: "json",
                        success: function (result) {
                            var returnData = result.d; // JSON.parse(result.d);
