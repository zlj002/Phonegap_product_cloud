<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Cloud_Server.Index" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script src="/plugins/echarts-2.0.4/doc/example/www/js/esl.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-sm-7 infobox-container">
                        <div class="infobox infobox-green  ">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">20个教师</div>
                            </div>
                        ...
                        <div class="infobox infobox-blue  ">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">鉴定项目</div>
                            </div>
                        ...
                        <div class="infobox infobox-pink  ">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">新增采购申请</div>
                            </div>
                        ...
                        <div class="infobox infobox-red  ">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">当前资产数量</div>
                            </div>
                        </div>
                        ...
                        <div class="infobox infobox-orange2  ">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-data-number">6,251,000.00  RMB</span>
                                <div class="infobox-content">资产总额</div>
                            </div>
                        ...
                        <div class="infobox infobox-blue2  ">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-text">折旧率</span>
                        ...
                        <div class="infobox infobox-green infobox-small infobox-dark">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">领用率</div>
                        ...
                        <div class="infobox infobox-blue infobox-small infobox-dark">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">借用率</div>
                        ...
                        <div class="infobox infobox-grey infobox-small infobox-dark">
                            ...
                            <div class="infobox-data">
                                ...
                                <div class="infobox-content">报废率</div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="hidden-480">
                                                    <span class="label label-info arrowed-right arrowed-in">审核中</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480">
                                                    <span class="label label-success arrowed-in arrowed-in-right">审核中</span>
                                                </td>
                                            </tr>
                        ...
                        <div class="widget-box transparent">
                            ...
                            <div class="widget-body">
                                <div class="widget-main padding-4">
                                       <div id="zhichu" style="height:280px"></div>
                                </div>
                                <!-- /widget-main -->
                            </div>
                            <!-- /widget-body -->
    ...
    <script type="text/javascript">
        ...
        require.config({
            paths: {
                'echarts': '../plugins/echarts-2.0.4/doc/example/www/js/echarts-map',
                'echarts/chart/pie': '../plugins/echarts-2.0.4/doc/example/www/js/echarts-map'
            }
        });
        ...
        require(
            ...
            function (ec) {
                // 基于准备好的dom，初始化echarts图表
                var myChart = ec.init(document.getElementById('zhichu'));
