/// <reference path="echarts/echarts.js" />
var ECharts = {
    ChartConfig: function (container, option) { //container:为页面要渲染图表的容器，option为已经初始化好的图表类型的option配置

        var chart_path = "/plugins/echart/echarts/echarts"; //配置图表请求路径


        var map_path = "/plugins/echart/echarts/echarts-map";//配置地图的请求路径
    ...
    ChartOptionTemplates: {
        ...
        Bar: function (data1, data2, name) {
            var pie_datas = ECharts.ChartDataFormate.FormateNOGroupData(data1);
            var option = {
                title: {
                    text: '柱状图',
                },
        ...
        Line: function (data, name,subname) {
            option = {
                title: {
                    text: name,
                    subtext: subname
